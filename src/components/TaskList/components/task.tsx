...
export function Task({
  ...
  return (
    <div className="flex w-full md:hover:scale-105 hover:transition hover:duration-300">
        ...
        <div className="flex w-full justify-between items-center">
          <div className="flex gap-6 items-center">
            ...
            <div className="flex flex-col gap-[10px]">
              <span
                onClick={() =>
                  !isSubtask && router.push(`/tasks/${id}/subtasks`)
                }
                {...attrs}
                ...
                } md:hover:text-secondary-300 md:hover:duration-300 md:hover:transition-all`}
              >
                {title}
              </span>
          ...
          <button onClick={handleDelete}>
            <Trash2
              ...
              className={`${
                completed ? 'text-gray-700' : 'text-gray-400'
              } md:hover:brightness-75 md:hover:duration-300 md:hover:transition-all`}
            />
          </button>
        </div>
      </Card>
