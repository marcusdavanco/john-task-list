      ...
      <div className="flex w-full justify-between items-center" >
        <div className="flex gap-6 items-center">
          ...
          <div className="flex flex-col gap-[10px]" >
            <span onClick={() => !path.endsWith('subtasks') && router.push(`${path}/foo/subtasks`)} {...attrs} className={`font-bold line-clamp-1 mr-4 ${completed ? ' text-gray-700 line-through' : 'text-gray-300'}`}>Really long todo description for testing purposes</span>
